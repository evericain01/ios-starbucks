...
class StarRewardsView: UIView {
    ...
    // Creating and populating an array of type Reward (struct)
    var rewards: [Reward] = [
...
extension StarRewardsView {
    ...
    func layout() {
        ...
        // Adding label into the stack view (have to us "addArrangedSubview")
        stackView.addArrangedSubview(label)
        
        // Adding the rewards data array into the stack view
        for reward in rewards {
            stackView.addArrangedSubview(StarRewardsRow(numberOfPoints: reward.numberOfPoints, description: reward.description))
        }
        
        // Adding stack view to view
